...
- Baileys (WhatsApp gratuito) é só um contrato/stub — a implementação real depende de decidir construir o microserviço Node.js separado (ver item 19 do changelog técnico e achado abaixo); nenhuma empresa consegue usá-lo ainda, só Z-API.
...
- ~~Notificações via WhatsApp (confirmação/lembrete de visita)~~ — feito com Z-API; Baileys (gratuito) fica pendente de decisão sobre construir o microserviço Node.js separado;
