...
class ExportacaoFiscalService
{
     ...
     */
    public function relatorio(Empresa $empresa, ?string $dataInicio, ?string $dataFim, ?string $status): Collection
    {
     ...
     */
    public function exportarXmlsZip(Empresa $empresa, ?string $dataInicio, ?string $dataFim): string
    {
        $documentos = $this->relatorio($empresa, $dataInicio, $dataFim, null)
     ...
     */
    public function exportarRelatorioContadorCsv(Empresa $empresa, ?string $dataInicio, ?string $dataFim): string
    {
        $documentos = $this->relatorio($empresa, $dataInicio, $dataFim, null);
